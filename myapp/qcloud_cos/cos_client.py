...
class CosS3Client(object):
        ...
        if session is None:
            ...
            self._session.mount(
                ...
                requests.adapters.HTTPAdapter(
                    pool_connections=self._conf._pool_connections,
    ...
    def get_presigned_url(self, Bucket, Key, Method, Expired=300, Params=None, Headers=None):
        """生成预签名的url
    ...
    def get_presigned_download_url(self, Bucket, Key, Expired=300, Params=None, Headers=None):
        """生成预签名的下载url
    ...
    def delete_objects(self, Bucket, Delete=None, **kwargs):
    ...
    def complete_multipart_upload(self, Bucket, Key, UploadId, MultipartUpload=None, **kwargs):
    ...
    def put_object_acl(self, Bucket, Key, AccessControlPolicy=None, **kwargs):
        """设置object ACL
    ...
    def restore_object(self, Bucket, Key, RestoreRequest=None, **kwargs):
    ...
    def put_bucket_acl(self, Bucket, AccessControlPolicy=None, **kwargs):
        """设置bucket ACL
        ...
        url = self._conf.uri(bucket=Bucket)
        logger.info(
            "put bucket acl, url=:{url} ,headers=:{headers}".format(url=url, headers=headers)
        )
        rt = self.send_request(
            method='PUT',
            url=url,
    ...
    def put_bucket_cors(self, Bucket, CORSConfiguration=None, **kwargs):
        """设置bucket CORS
    ...
    def put_bucket_lifecycle(self, Bucket, LifecycleConfiguration=None, **kwargs):
        """设置bucket LifeCycle
        ...
        """
        # 类型为list的标签
        if LifecycleConfiguration is None:
    ...
    def put_bucket_replication(self, Bucket, ReplicationConfiguration=None, **kwargs):
        """设置bucket跨区域复制配置
        ...
        """
        if ReplicationConfiguration is None:
    ...
    def put_bucket_website(self, Bucket, WebsiteConfiguration=None, **kwargs):
        """设置bucket静态网站配置
        ...
        """
        if WebsiteConfiguration is None:
    ...
    def put_bucket_logging(self, Bucket, BucketLoggingStatus=None, **kwargs):
        """设置bucket logging
        ...
        """
        if BucketLoggingStatus is None:
            BucketLoggingStatus = {}
    ...
    def put_bucket_domain(self, Bucket, DomainConfiguration=None, **kwargs):
        """设置bucket的自定义域名
        ...
        """
        if DomainConfiguration is None:
            DomainConfiguration = {}
    ...
    def put_bucket_origin(self, Bucket, OriginConfiguration=None, **kwargs):
        """设置bucket的回源规则
        ...
        """
        if OriginConfiguration is None:
            OriginConfiguration = {}
    ...
    def put_bucket_inventory(self, Bucket, Id, InventoryConfiguration=None, **kwargs):
        """设置bucket的清单规则
        ...
        """
        if InventoryConfiguration is None:
    ...
    def put_bucket_tagging(self, Bucket, Tagging=None, **kwargs):
        """设置bucket的标签
    ...
    def put_bucket_referer(self, Bucket, RefererConfiguration=None, **kwargs):
        """设置bucket的防盗链规则
        ...
        """
        if RefererConfiguration is None:
    ...
    def _upload_part(self, bucket, key, local_path, offset, size, part_num, uploadid, md5_lst, resumable_flag,
                     already_exist_parts, enable_md5, traffic_limit):
            ...
            for i in range(1, parts_num + 1):
                if i == parts_num:  # 最后一块
                    ...
                    pool.add_task(self._upload_part, Bucket, Key, LocalFilePath, offset, part_size, i, uploadid, lst,
                                  resumable_flag, already_exist_parts, EnableMD5, traffic_limit)
                    offset += part_size
    ...
    def put_async_fetch_task(self, Bucket, FetchTaskConfiguration=None, **kwargs):
        """发起异步拉取对象到COS的任务
        ...
        """
        if FetchTaskConfiguration is None:
            FetchTaskConfiguration = {}
