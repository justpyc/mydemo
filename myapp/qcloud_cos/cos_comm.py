...
def format_xml(data, root, lst=None, parent_child=False):
...
def format_region(region):
    ...
    if region == u'cn-north' or region == u'cn-south' or region == u'cn-east' or region == u'cn-south-2' \
            or region == u'cn-southwest' or region == u'sg':
